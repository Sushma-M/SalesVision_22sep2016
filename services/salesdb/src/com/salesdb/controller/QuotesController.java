...
public class QuotesController {
    ...
    public Page<Quotes> findQuotess(Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
    ...
    public Quotes editQuotes(@PathVariable("id") Integer id, @RequestBody Quotes instance) throws EntityNotFoundException {
