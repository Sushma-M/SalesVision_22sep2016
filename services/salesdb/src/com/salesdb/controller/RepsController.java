...
public class RepsController {
    ...
    public Page<Reps> findRepss(Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
    ...
    public Reps editReps(@PathVariable("id") Integer id, @RequestBody Reps instance) throws EntityNotFoundException {
